...
Here we take you through running the model Jupyter notebook. To download and run it yourself, you can find the notebook :nbviewer_docs:`here <user/tutorials/national_scale.ipynb>`.You will need to have Calliope installed.
...
Here we take you through running the model Jupyter notebook. To download and run it yourself, you can find the notebook :nbviewer_docs:`here <user/tutorials/urban_scale.ipynb>`.You will need to have Calliope installed.
...
Here we take you through running the model Jupyter notebook. To download and run it yourself, you can find the notebook :nbviewer_docs:`here <user/tutorials/milp.ipynb>`.You will need to have Calliope installed.
