...
repository, then just download `this requirements file <https://raw.githubusercontent.com/calliope-project/calliope/master/requirements_git_master.yml>`_ and then run::
