...
|fixed| Documentation improvements: Show operate math mode, clarify dimension subsetting documentation, always reference `Model.read_yaml(path)` rather than `Model(path)` (#829)
