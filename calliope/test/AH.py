...
class TestAH:
    def dev_test(self):
        ...
        csp_resource = pd.read_csv(os.path.join(timeseries_dir, 'csp_resource.csv'),
                                   index_col=0)
        demand_1 = pd.read_csv(os.path.join(timeseries_dir, 'demand-1.csv'), index_col=0)
        demand_2 = pd.read_csv(os.path.join(timeseries_dir, 'demand-2.csv'), index_col=0)
        ...
        override_dict_csv = {
            ...
            'locations.region1.techs.demand_power.constraints.resource': 'file=demand-1.csv:demand',
            'locations.region2.techs.demand_power.constraints.resource': 'file=demand-2.csv:demand',
        }

        override_dict_df = {
            'techs.csp.constraints.resource': 'df=csp_resource',
            'locations.region1.techs.demand_power.constraints.resource': 'df=demand_1',
            'locations.region2.techs.demand_power.constraints.resource': 'df=demand_2',
        }

        calliope.Model(os.path.join(model_dir, 'model.yaml'), override_dict=override_dict_df,
