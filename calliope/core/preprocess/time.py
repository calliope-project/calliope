...
def add_zero_carrier_ratio_sets(model_data):
    ...
    zero_dims = (
        carrier_ratios
        .where((carrier_ratios == 0) & (carrier_ratios.loc_tech_carriers_carrier_ratios.isin(model_data.get('loc_tech_carriers_conversion_plus',[]))))
        .dropna('loc_tech_carriers_carrier_ratios', how='all')
