    ...
    for loc_tech in model_data.loc_techs.values:
        ...
        if _is_in(loc_tech, "loc_techs_store"):
            ...
            if not pd.isnull(storage_cap) and not pd.isnull(energy_cap):
                ...
                if (
                    _get_param(loc_tech, "energy_cap_per_storage_cap_max")
                    is not False
                ):
                    ...
                    if (
                        storage_cap * energy_cap_per_storage_cap_max
                        < energy_cap
                    ):
                        errors.append(
                ...
                if (
                    _get_param(loc_tech, "energy_cap_per_storage_cap_min")
                    is not False
                ):
                    ...
                    if (
                        storage_cap * energy_cap_per_storage_cap_min
                        > energy_cap
                    ):
                        errors.append(
