function load_energy_balance_constraints(dataset, sets, parameters, backend_model)
    ...
    if haskeys(sets, "loc_techs_finite_resource_supply_plus")
    ...
    if haskeys(sets, "loc_techs_finite_resource_supply")
...
function resource_availability_constraint_rule(backend_model, set_indices)
...
# Supply Balance
function balance_supply_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
    ...
    energy_eff = (
        1 / timesliced_variable("energy_eff", timestep)[loc_tech] if
...
# Demand Balance
function balance_demand_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
    loc_tech_carrier = parameters["lookup_loc_tech_carriers"][loc_tech]
...
function balance_transmission_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
    loc_tech_carrier = parameters["lookup_loc_tech_carriers"][loc_tech]
...
# Conversion Balance
function balance_conversion_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
...
function balance_conversion_plus_out_2_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
...
function balance_conversion_plus_out_3_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
    carrier_out = get_carrier(loc_tech, "out")
...
function balance_conversion_plus_in_2_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
...
function balance_conversion_plus_in_3_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
    carrier_in = get_carrier(loc_tech, "in")
...
# Supply_plus Balance
function balance_supply_plus_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
    loc_tech_carrier = parameters["lookup_loc_tech_carriers"][loc_tech]
    total_eff = (timesliced_variable("energy_eff", timestep)[loc_tech] *
                 timesliced_variable("parasitic_eff", timestep)[loc_tech])
...
# Storage Balance
function balance_storage_constraint_rule(backend_model, set_indices)
    loc_tech, timestep = set_indices
    loc_tech_carrier = parameters["lookup_loc_tech_carriers"][loc_tech]
    energy_eff = timesliced_variable("energy_eff", timestep)[loc_tech]
