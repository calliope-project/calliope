...
1. Ensure the Gurobi Python library is installed in your Calliope environment (included in this repository's pixi-managed environments).
...
Therefore, we recommend you use GLPK when you are first starting out with Calliope (included in this repository's pixi `dev` environment).
