...
model_from_yaml = calliope.read_dict(model_def)
...
model_from_data_tables = calliope.read_dict(model_def)
...
model_from_data_tables = calliope.read_dict(
    model_def,
    data_table_dfs={
...
model_from_data_tables_w_override = calliope.read_dict(model_def)
