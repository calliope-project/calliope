...
We recommend you first review the math formulation [syntax](syntax.md),
then get an overview of the available [math components](components.md),
before looking at how to add your own [custom math](customise.md) and browsing the [gallery of custom math examples](examples/index.md).
